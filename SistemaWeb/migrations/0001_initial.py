# Generated by Django 5.1.7 on 2025-04-28 01:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(choices=[('Sillas', 'Sillas'), ('Mesas', 'Mesas'), ('Manteles', 'Manteles'), ('Otros', 'Otros')], default='Sillas', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Orden',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SistemaWeb.categoriaproducto')),
            ],
        ),
        migrations.CreateModel(
            name='OrdenProducto',
            fields=[
                ...
                ('orden', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SistemaWeb.orden')),
